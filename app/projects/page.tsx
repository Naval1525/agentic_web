...
const projects: Project[] = [
    ...
    },
    {
        ...
        liveUrl:
            "https://www.linkedin.com/posts/devanshi-jaiswal-b83774217_aiinsales-salesautomation-futureofoutreach-activity-7296915013691195392-7Xjq?utm_source=share&utm_medium=member_desktop&rcm=ACoAADbAnJMB6L7n9WfYupSHXDDuz_zW4l8Lxa0",
    ...
    },
    {
        ...
        liveUrl:
            "https://www.linkedin.com/posts/devanshi-jaiswal-b83774217_langchain-automation-datasecurity-activity-7329486872466849792-uh8F?utm_source=share&utm_medium=member_desktop&rcm=ACoAADbAnJMB6L7n9WfYupSHXDDuz_zW4l8Lxa0",
    ...
    <div className="mb-8">
        ...
        >
            <div className="flex items-center space-x-4">
                ...
                <span className="text-sm text-gray-400 bg-gray-700 px-2 py-1 rounded-full">
                    {projects.filter((p) => p.category === title).length}{" "}
                    projects
                </span>
            </div>
        ...
        <div
            className={`grid transition-all duration-300 ease-in-out ${
                isOpen
                    ? "mt-6 opacity-100 max-h-[2000px] scale-100"
                    : "mt-0 opacity-0 max-h-0 scale-95 pointer-events-none"
            }`}
            ...
            <div className="relative z-10 container mx-auto px-4 py-16 max-w-7xl">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8">
                        Explore my latest projects spanning AI, web development,
                        and fintech solutions. Each project showcases different
                ...
                <div className="text-center bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-12 border border-blue-500/30">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <button className="px-8 py-3 bg-gray-700 hover:bg-gray-600 text-white rounded-lg font-semibold transition-colors">
                            <Link
                                href={"https://linktr.ee/astrafloww"}
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                View LinkTree

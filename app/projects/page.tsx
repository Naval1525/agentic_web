...
const projects = [
  ...
  },
  {
    ...
    description: 'A beautiful weather app with detailed forecasts, location-based weather, and customizable widgets.',
    image: '/api/placeholder/400/250',
  ...
  // UI/UX Design
  {
    ...
    description: 'A complete redesign of a banking app focusing on user experience and accessibility.',
    image: '/api/placeholder/400/250',
  ...
  },
  {
    ...
    description: 'Modern food delivery app interface with intuitive navigation and engaging visuals.',
    image: '/api/placeholder/400/250',
  ...
  // Data Science
  {
    ...
    description: 'Machine learning model to predict sales trends and optimize inventory management.',
    image: '/api/placeholder/400/250',
  ...
  },
  {
    ...
    description: 'NLP-powered sentiment analysis tool for customer feedback and social media monitoring.',
    image: '/api/placeholder/400/250',
...
const CollapsibleSection = ({ children, title, icon, color, isOpen, onToggle }) => (
  <div className="mb-8">
    <button
      onClick={onToggle}
...
export default function PortfolioShowcase() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,_rgba(255,255,255,0.05)_1px,_transparent_0)] bg-[size:20px_20px] opacity-30" />
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Explore my latest projects and see how I bring ideas to life through code, design, and innovation.
          </p>
        </div>

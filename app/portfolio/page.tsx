...
const projects = [
  ...
  },
  {
    ...
    description:
      "A comprehensive financial dashboard design for a fintech startup, featuring intuitive data visualization and user-friendly interface.",
    image: "/placeholder.jpg",
  ...
  },
  {
    ...
    description:
      "A mobile application for healthcare providers to manage patient records, appointments, and communication.",
    image: "/placeholder.jpg",
  ...
  },
  {
    ...
    description:
      "A modern real estate website with property listings, search functionality, and agent profiles.",
    image: "/placeholder.jpg",
  ...
  // AI Automation
  {
    ...
    description:
      "Automate your email campaigns, follow-ups, and notifications with smart triggers and personalized content.",
    image: "/placeholder.jpg",
  ...
  },
  {
    ...
    description:
      "Capture, qualify, and route leads automatically from your website and ads to your CRM.",
    image: "/placeholder.jpg",
  ...
  // AI Agents-as-a-Service
  {
    ...
    description:
      "An AI-powered sales agent that automatically qualifies leads, books meetings, and updates your CRM.",
    image: "/placeholder.jpg",
  ...
  },
  {
    ...
    description:
      "A virtual AI receptionist that answers calls, schedules appointments, and provides information 24/7.",
    image: "/placeholder.jpg",
  ...
  },
  {
    ...
    description:
      "A smart agent that qualifies leads in real-time and routes them to the right sales rep.",
    image: "/placeholder.jpg",
  ...
  },
  {
    ...
    description:
      "An AI agent that handles bookings and calendar invites for your business automatically.",
    image: "/placeholder.jpg",
  ...
  // AI Chatbots
  {
    ...
    description:
      "A chatbot trained on your business data, integrated with Slack and WhatsApp for instant support.",
    image: "/placeholder.jpg",
  ...
  // AI-Powered Digital Marketing
  {
    ...
    description:
      "An AI-powered content generation tool that creates high-quality, SEO-optimized content for various industries.",
    image: "/placeholder.jpg",
  ...
  },
  {
    ...
    description:
      "Automated ad campaign management with AI-driven creative testing and budget optimization.",
    image: "/placeholder.jpg",
  ...
  // AI-Generated Product Ads
  {
    ...
    description:
      "Instantly generate product visuals, captions, and UGC-style video scripts for your brand.",
    image: "/placeholder.jpg",
      ...
      >
                  ...
                  {catProjects.map((project) => (
                    ...
                    >
                      ...
                      <div className="flex gap-2 mt-2 sm:mt-3">
                        ...
                        >
                          <Link href={project.link}>Details</Link>
                        </Button>
                        {project.url && (
                          <Button
                            asChild
        ...
        >
          ...
          <Button
            asChild
            size="lg"
            className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-6 sm:px-8 py-3 text-base sm:text-lg font-semibold"
          >
            <a
